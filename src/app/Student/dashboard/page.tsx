...
export default function StudentTable() {
  ...
  return (
    <div>
      <div className="container mx-auto py-3 m-3">
        <p className="text-2xl font-bold">
          <div
            className={`border rounded-md h-full max-w-max p-3 ${student?.mentorName ? "w-auto" : "w-[55vh]"}`}
          >
            My mentor: {student?.mentorName || "Mentor not assigned"}
          </div>
        </p>
      </div>
